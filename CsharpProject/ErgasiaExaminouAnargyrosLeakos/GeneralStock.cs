...
{
    public partial class GeneralStock : Form
    {
        public GeneralStock()
        {
            InitializeComponent();
        ...
        {
            this.Hide();
            var ProductsLowStock = new ProductsLowStock();
            ProductsLowStock.Closed += (s, args) => this.Close();
            ProductsLowStock.Show();
        }

        private void ShowGeneralStockButton_Click(object sender, EventArgs e)
        {
            dataGridView1.Show();
